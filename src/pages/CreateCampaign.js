...
const CreateCampaign = () => {
  ...
  <div className="bg-gradient-to-r from-sky-800 to-pink-500 bg-clip-text  text-transparent text-5xl font-bold">Start Your</div>
  <div className="bg-gradient-to-r from-sky-800 to-pink-500 bg-clip-text  text-transparent text-6xl font-bold p-2">Campaign</div>
  <div className="text-gray-800 mt-8 italic font-light text-xl max-w-md mx-auto ">
    "Beyond boundaries, beyond limits. Your crowdfunding campaign is the catalyst for boundless possibilities. Start shaping tomorrow, today."
        ...
        <form
            ...
            className="flex justify-center items-center flex-col  rounded-2xl p-4 shadow-2xl	bg-gray-400 text-gray-800   mt-7 box w-3/5"
          >
            <div className="text-gray-200 text-4xl font-bold  bg-slate-700 w-full h-20 flex justify-center items-center rounded-xl">
