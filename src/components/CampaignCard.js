...
const CampaignCard = ({owner,title,description,target,deadline,amountCollected, image, handleClick}) => {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-100 to-gray-300 shadow-lg rounded-lg overflow-hidden max-w-sm cursor-pointer relative transition duration-300 hover:bg-opacity-80 hover:transform hover:scale-105" onClick={handleClick}>
